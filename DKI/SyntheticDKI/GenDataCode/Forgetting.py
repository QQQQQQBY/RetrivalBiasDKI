...
def generate_data_main():
    ...
    parser.add_argument("--output", type=str, default="DKI/SyntheticDKI/InterventionDataset/synthetic_Forgetting_32.json")
    ...
    "\n"
    "Thinking rule: \n"
        "When encountering a new cue:value pair, recall the previous cue:value pair in the list, and think about both cue:value pairs at the same time."
    "\n"
