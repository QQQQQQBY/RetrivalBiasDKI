...
def generate_data_main():
    ...
    parser.add_argument("--output_file", type=str, default="DKI/RealWorldDKI/InterventionDataset/RealWorld_Index.json")
    ...
    input_text = (
        ...
        "- Index is a monotonically increasing integer (0, 1, 2, ...). It only indicates the order;\n"
