...
def generate_data_main():
    ...
    parser.add_argument("--output_file", type=str, default="DKI/RealWorldDKI/InterventionDataset/RealWorld_CoT.json")
    ...
    instruction = (
        ...
        "- Think step by step to solve the task, but keep all reasoning hidden.\n"
        "- Do NOT output any explanations or reasoning; output only the final JSON object.\n"
        "\n"
    )
    input_text = (
