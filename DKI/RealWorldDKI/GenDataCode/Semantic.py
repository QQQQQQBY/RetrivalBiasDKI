...
def generate_data_main():
    ...
    parser.add_argument("--output_file", type=str, default="DKI/RealWorldDKI/InterventionDataset/RealWorld_Semantic.json")
    ...
    instruction = (
        ...
        "\n"
        "Thinking rule:\n"
        "Create a meaningful association between the next cue:value pair and the previous cue:value pair based on semantic meaning. Create these associations internally and do not output it in your response.\n"
        "\n"
    )
    input_text = (
